local opts = { -- Useful plugin to show you pending keybinds.
  ...
  config = function() -- This is the function that runs, AFTER loading
    ...
    wk.add {
      ...
      { '<leader>lo', group = '[O]bjects', icon = '󰅩' },
      ...
      { '<leader>wa', group = '[A]tlas', icon = '' },
      { '<leader>wac', group = '[C]omment', icon = '' },
      { '<leader>war', group = '[R]eview', icon = '' },
      { '<leader>wai', group = '[I]ssues', icon = '' },
      { '<leader>wr', group = '[R]sync', icon = '' },
      { '<leader>wru', group = '[U]pload', icon = '󰕒' },
      { '<leader>wrd', group = '[D]ownload', icon = '󰇚' },
      { '<leader>wrc', group = '[C]onfig', icon = '' },
      ...
      { '<leader>gf', group = '[F]orge', mode = { 'n', 'v' }, icon = '' },
      { '<leader>gfg', group = '[G]ithub', mode = { 'n', 'v' }, icon = '' },
      { '<leader>gs', group = 'Search', mode = { 'n', 'v' }, icon = '' },
      { '<leader>gd', group = '[D]iff Management', icon = '󰔢' },
      { '<leader>gdt', group = '[T]oggle', icon = '󰔢' },
      ...
      { '<leader>bc', group = 'Arrange-Act-Assert', mode = { 'n', 'v' }, icon = '' },

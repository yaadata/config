  ...
  config = function()
    require('codediff').setup {
      ...
      highlights = {
        ...
        conflict_sign = '#f0883e', -- Unresolved: DiagnosticSignWarn -> #f0883e
        conflict_sign_resolved = '#6e7681', -- Resolved: Comment -> #6e7681
        conflict_sign_accepted = '#3fb950', -- Accepted: GitSignsAdd -> DiagnosticSignOk -> #3fb950
        conflict_sign_rejected = '#f85149', -- Rejected: GitSignsDelete -> DiagnosticSignError -> #f85149
      },

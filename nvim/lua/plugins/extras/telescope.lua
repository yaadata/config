local opts = { -- Fuzzy Finder (files, lsp, etc)
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>sqh', '<cmd>Telescope quickfixhistory<CR>', { desc = 'History' })
    vim.keymap.set('n', '<leader>sqo', '<cmd>Telescope quickfix<CR>', { desc = '[O]pen quickfix list' })

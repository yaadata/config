# How to run `git town contribute`
...
2. Inspect command-specific flags with `git town contribute --help`.
...
https://github.com/git-town/git-town/blob/main/website/src/commands/contribute.md

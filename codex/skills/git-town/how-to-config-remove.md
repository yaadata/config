# How to run `git town config remove`
...
The config remove command removes all Git Town related configuration from the
...
2. Inspect command-specific flags with `git town config remove --help`.
...
https://github.com/git-town/git-town/blob/main/website/src/commands/config-remove.md

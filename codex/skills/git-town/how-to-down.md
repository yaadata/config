...
The down command moves one position down in the current stack by switching to
the parent of the current branch.
...
2. Inspect command-specific flags with `git town down --help`.
...
https://github.com/git-town/git-town/blob/main/website/src/commands/down.md

...
The repo command ("show me the repository") opens the homepage of the current
...
2. Inspect command-specific flags with `git town repo --help`.
...
https://github.com/git-town/git-town/blob/main/website/src/commands/repo.md

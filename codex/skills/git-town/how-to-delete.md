...
The delete command deletes the given branch from the local and if possible the
remote repository, removes commits of deleted branches from their descendents
(unless when using the merge sync strategy), and updates...
...
2. Inspect command-specific flags with `git town delete --help`.
...
git town delete --dry-run
```

## Source

Upstream command documentation:
https://github.com/git-town/git-town/blob/main/website/src/commands/delete.md
